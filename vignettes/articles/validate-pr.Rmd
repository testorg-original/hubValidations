...
The hubverse maintains the [**`validate-submission.yaml`**](https://github.com/testorg-original/hubverse-actions/tree/main/validate-submission) GitHub Action workflow template for deploying `validate_pr()`.
